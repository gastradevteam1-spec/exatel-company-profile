// All page copy lives here, separated from the components that render it.
// This is the file non-developer staff would eventually edit (directly, or
...
export const about = {
  ...
  title: "PT. Elemen Jaringan Nusantara (Exatel)",
  paragraphs: [
    "Exatel adalah perusahaan yang berfokus pada infrastruktur telekomunikasi, terutama sebagai penyedia jaringan fiber optic, penyedia layanan internet dan solusi IT.",
    "Exatel mengedepankan pendekatan netralitas untuk menyediakan infrastruktur jaringan yang dapat diakses oleh semua penyedia dan penerima layanan, dengan komitmen untuk meningkatkan kualitas dan cakupan layanan internet di seluruh Indonesia.",
    "Exatel hadir di tengah persaingan industri telekomunikasi digital yang pesat untuk memberikan solusi yang lebih baik. Dengan latar belakang dan pengalaman lebih dari 20 tahun, Exatel yakin dan optimis dalam menghadapi segala tantangan serta berkomitmen untuk terus berinovasi dalam menyediakan solusi dan layanan terbaik yang dapat diandalkan oleh semua pihak.",
  ],
  figureYears: "20+",
  figureCaption:
    "tahun latar belakang dan pengalaman di industri telekomunikasi.",
  figureNote:
    "Pendekatan netral — infrastruktur yang dapat diakses oleh semua penyedia layanan berbasis IP.",
};

export const visionMission = {
  eyebrow: "VISI & MISI",
  title: "Ke mana arah kami, dan bagaimana kami sampai di sana.",
  vision:
...
export const groupCompanies = [
  { name: "Jembo Cable", tag: "Together We Grow", image: "/images/jembocable.png" },
  { name: "Jembo Energindo", tag: "Energy & infrastructure", image: "/images/energindo.png" },
  { name: "Sinarmonas Industries", tag: "Committed to Quality", image: "/images/sinarmonas.png" },
];

export const whyUs = {
  eyebrow: "MENGAPA HARUS KAMI",
  title:
    "Keunggulan yang memperkuat posisi Exatel di industri telekomunikasi.",
  items: [
    {
      tag: "NETRAL",
      title: "Infrastruktur Jaringan Netral",
      body: "Exatel membangun jaringan dengan prinsip netralitas, memungkinkan penyedia layanan berbasis IP — internet, IPTV, dan telekomunikasi — untuk memperluas jangkauan layanan ke seluruh pelosok Indonesia.",
    },
    {
      tag: "PERFORMA",
      title: "Cepat dan Stabil",
      body: "Dengan infrastruktur fiber optic berteknologi terbaru, Exatel mampu menyediakan jaringan berkualitas tinggi dengan kecepatan tinggi, memungkinkan komunikasi data yang lancar, cepat dan stabil.",
    },
    {
      tag: "KEAMANAN",
      title: "Aman",
      body: "Infrastruktur fiber optic Exatel memiliki daya tahan tinggi terhadap gangguan, jangkauan luas, serta tingkat keamanan yang baik, sehingga layanan yang disediakan aman bagi pelanggan.",
    },
    {
      tag: "SDM",
      title: "Handal",
  ...
  items: [
    ...
    },
    {
      ...
      tags: [
        ...
        "Fiber Building Managed Service",
      ],
    },
  ],
};

export const networkSolution = {
  eyebrow: "EXATEL NETWORK SOLUTION",
  title:
  ...
  blocks: [
    {
      ...
      paragraphs: [
        ...
        "Layanan ini merupakan inovasi baru di industri telekomunikasi Indonesia — Exatel tidak menjual layanan internet langsung kepada end user, melainkan memberikan peluang ini sepenuhnya kepada ISP/Subnet ISP, memperkuat ekosistem ekonomi digital yang sehat.",
      ],
    },
    {
      num: "02",
      ...
      features: [
        ...
        "Point to Multipoint — koneksi dari satu titik ke beberapa titik lainnya.",
        "Multipoint to Multipoint — koneksi yang menghubungkan banyak titik sekaligus.",
      ],
    },
  ],
};
  ...
  blocks: [
    {
      ...
      features: [
        "Layanan tersedia mulai dari 50 Mbps s/d 10 Gbps",
        "Service Level Agreement 99,5%",
        "Support dan Customer Care 24x7",
        "Konektivitas 24/7 dengan rasio bandwidth CIR (1:1)",
        "Unlimited internet dengan 1 IP Public",
        "Dukungan layanan penambahan IP Public (jika diperlukan)",
        "Traffic bandwidth monitoring real-time",
        "Gratis peminjaman 1 unit router Mikrotik (tipe menyesuaikan kebutuhan)",
      ],
    },
    {
      num: "02",
      ...
      features: [
        ...
        "Support dan Customer Care 24x7",
        "Kapasitas bandwidth besar untuk akses lokal dan internasional",
        "Internet unlimited dengan 1 IP publik",
        "Traffic bandwidth monitoring real-time",
        "Gratis peminjaman 1 unit router Mikrotik (tipe menyesuaikan kebutuhan)",
      ],
    },
...
export const managedService = {
  eyebrow: "EXATEL MANAGED SERVICE",
  title:
    "Mendelegasikan operasional IT sehari-hari, tanpa menambah beban tim.",
  ...
  process: [
    ...
    "CPE, Device & Third Party Integration",
...
export const partners = [
  { name: "Kominfo", image: "/images/kominfo.svg" },
  { name: "IDNIC", image: "/images/idnic.png" },
  { name: "APJII DKI Jakarta", image: "/images/apjii.jpg" },
  { name: "Supercorridor", image: "/images/supercorridor.png" },
  { name: "JKT-IX", image: "/images/jkt-ix.png" },
  { name: "Tower Bersama Group", image: "/images/tower.png" },
  { name: "Amron Citinet", image: "/images/amron.jpg" },
  { name: "OpenIXP", image: "/images/openixp.png" },
  { name: "Delta Art Star", image: "/images/DAS-LOGO-Transp.png" },
  { name: "Infotama Lintas Global", image: "/images/ilg.png" },
  { name: "Atlas Fiber Indonesia", image: "/images/atlas.png" },
  { name: "Sokka Fiber", image: "/images/soka.webp" },
  { name: "Fibernet Indonesia", image: "/images/fibernet.png" },
  { name: "Lintasarta", image: "/images/Lintasarta.avif" },
];
